...
from models.gated_neuron import GatedNeuronBlock
...
class ContinuousThoughtMachine(nn.Module, PyTorchModelHubMixin):
    ...
    def get_d_backbone(self):
        ...
        """
        if self.backbone_type == 'mnist-backbone':
            return self.d_input
        elif self.backbone_type == 'shallow-wide':
            return 2048
    ...
    def set_backbone(self):
        ...
        elif self.backbone_type == 'mnist-backbone':
